    ...
    render() {
        return (
            <div className='greeting-and-game-rules-page'>
                <h2 className='player-greeting-heading'>Welcome To The 'Memory Game'</h2>
                <p className='about-game-paragraph'>
                    'Memory' is a game for brain training<br /> where the goal is to find the same Cards
                </p>
                ...
                <Link to='/registration' className='player-profile-register-button'>Registration</Link>
            </div>
        );
    }
}
